...
if (version == '2') {
  switchVersion(2)
  console.log(`[@vue-async/module-loader] Switched types for Vue 2`)
  exec(`npx vue-demi-switch 2 ${vueEntry}`)
  console.log(`[vue-demi] Switched for Vue 2 (entry: "${vueEntry}")`)
} else if (version == '3') {
  switchVersion(3)
  console.log(`[@vue-async/module-loader] Switched types for Vue 3`)
  exec(`npx vue-demi-switch 3 ${vueEntry}`)
  console.log(`[vue-demi] Switched for Vue 3 (entry: "${vueEntry}")`)
} else {
  console.warn(
    `[@vue-async/module-loader] expecting version "2" or "3" but got "${version}"`
  )
  process.exit(1)
}