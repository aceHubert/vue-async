<template>
  <div class="playground">
    <h3>通过子模块注入的页面：</h3>
    <NuxtLink style="margin: 0 10px 5px; display: block" to="/dymanic-router/page-a"> Remote Page load </NuxtLink>
    <h3>在页面中加截远端组件：</h3>
    ...
    <NuxtLink style="margin: 0 10px 5px; display: block" :to="{ name: 'remote-component-route' }">
      Remote Component load
    </NuxtLink>
